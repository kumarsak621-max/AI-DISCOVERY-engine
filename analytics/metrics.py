        ...
        records.append(
            {
                ...
                "wishlist_intent": getattr(row, "wishlist_intent", "") or "",
                "purchase_intent": row.purchase_intent,
                "purchase_status": row.purchase_status,
                "theme": getattr(row, "theme", "") or "",
                ...
                "uncertainty_level": getattr(row, "uncertainty_level", "") or "",
                "pain_point": getattr(row, "pain_point", "") or "",
                "pain_point_evidence": getattr(row, "pain_point_evidence", "") or "",
                ...
                "analysis_provider": getattr(row, "analysis_provider", "") or "",
                "analysis_model": getattr(row, "analysis_model", "") or "",
                "analysis_status": conv.analysis_status if conv else "",
